#!/usr/bin/env bash
# Automated build, flash, and RTT verification for dual-blink-stm32f103c8-bluepill.
set -euo pipefail

ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
EXAMPLE="$ROOT/examples/dual-blink-stm32f103c8-bluepill"
TARGET="thumbv7m-none-eabi"
ELF="$ROOT/target/$TARGET/release/dual-blink-stm32f103c8-bluepill"
CHIP="STM32F103C8"
LOG="${RUGUS_RTT_LOG:-/tmp/rugus-rtt-dual-verify-f103.log}"
...
echo "=== Rugus verify: dual-blink-stm32f103c8-bluepill ==="
echo "Root: $ROOT"
echo "Log:  $LOG"
