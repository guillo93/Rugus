//! Independent watchdog (IWDG) para STM32F4 — raw-MMIO, gemelo del de F7.
//!
...
//! 0x4000_3000), por eso este driver es un gemelo exacto del de F7. Acceso por
//! MMIO directo en la misma línea que [`crate::gpio`]/[`crate::usart`].
//!
//! Secuencia: `configure` desbloquea (KR=0x5555), fija prescaler y reload, luego
//! `arm` (KR=0xCCCC) lo arranca — esto también enciende el LSI automáticamente.
//! A partir de ahí hay que `kick` (KR=0xAAAA) antes de que venza el reload.
