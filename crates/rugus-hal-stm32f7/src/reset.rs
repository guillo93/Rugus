//! Causa del último reset (RCC_CSR) para STM32F7 — raw-MMIO, gemelo del de F4.
//!
...
//!
//! El mapa de `CSR` (offset 0x74, mismos bits altos) es idéntico al de F4, así
//! que este driver es un gemelo exacto. Acceso por MMIO directo, en la línea de
//! [`crate::iwdg`].
