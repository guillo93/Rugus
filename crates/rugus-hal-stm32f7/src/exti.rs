//! EXTI del botón de usuario B1 (PA0) — primer IRQ no-SysTick, gemelo del de F4.
//!
//! El botón B1 de la STM32F769I-DISCO está en PA0 (activo alto, pull-down
...
//! gemelo del de F4. Acceso MMIO directo, en la línea de [`crate::gpio`].
