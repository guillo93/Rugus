...
| Role | IPv4 | Notes |
|------|------|-------|
| F769 board | `192.168.1.50/24` | Static (`StaticConfig::home_lan()`) |
| Gateway | `192.168.1.1` | Typical home router |
| HTTPS server (PC) | `192.168.1.100:8443` | `Endpoint::lan_https_server()` |
...
On the server PC (`192.168.1.100`):
